...
// Definindo os dados das cidades
int pontos_turisticos_esmeraldas = 15;
float populacao_esmeraldas = 0.07; // 70,000 habitantes em milhões
float area_esmeraldas = 908.5; // km²
float PIB_esmeraldas = 1.2; // em bilhões de reais
...
float populacao_bh = 2.52; // 2,520,000 habitantes em milhões
float area_bh = 331.4; // km²
float PIB_bh = 94.3; // em bilhões de reais
char codigo_de_cidade_bh[] = "A02";
char nome_da_cidade_e_estado_bh[] = "Belo Horizonte, Minas Gerais";

int pontos_turisticos_betim = 10;
float populacao_betim = 0.43; // 430,000 habitantes em milhões
float area_betim = 345.9; // km²
float PIB_betim = 20.1; // em bilhões de reais
char codigo_de_cidade_betim[] = "A03";
char nome_da_cidade_e_estado_betim[] = "Betim, Minas Gerais";

int pontos_turisticos_mc = 12;
float populacao_mc = 0.41; // 410,000 habitantes em milhões
float area_mc = 3569.3; // km²
float PIB_mc = 12.7; // em bilhões de reais
...
int main() {
    ...
    do {
        // Solicita ao usuário para inserir o código da cidade
        ...
        // Verifica a entrada do usuário e exibe uma mensagem específica
        exibir_dados_da_cidade(entrada);

        // Pergunta ao usuário se ele deseja pesquisar outra carta
